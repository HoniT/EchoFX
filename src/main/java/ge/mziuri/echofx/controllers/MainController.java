...
public class MainController {
    ...
    private void onLogin(ActionEvent event) throws SQLException, IOException {
        ...
        UserRepository.logIntoUser(username, EncryptionService.encryptPassword(password));
    ...
    private void onSignup(ActionEvent event) throws SQLException, IOException {
        ...
        UserRepository.addUser(username, email,EncryptionService.encryptPassword(password));
